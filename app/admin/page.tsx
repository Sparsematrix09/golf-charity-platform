    ...
    <div>
      ...
      <div className="grid-4" style={{ marginBottom: 32 }}>
        {[
          ...
          { label: 'Total Charity Raised', value: `£${stats.totalDonations.toFixed(2)}`, icon: '❤️', color: 'var(--clr-danger)' },
        ...
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
            {[
              ...
              { href: '/admin/charities', label: '❤️ Add New Charity', btn: 'btn-outline' },
