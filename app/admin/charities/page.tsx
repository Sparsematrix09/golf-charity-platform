...
>
 ...
 <input id="charity-emoji" type="text" className="form-input" value={form.emoji} onChange={(e) => setForm({ ...form, emoji: e.target.value })} placeholder="" maxLength={4} />
 </div>
 </div>
 <div className="form-group">
 ...
 <span style={{ fontSize: '2.5rem' }} aria-hidden="true">{c.emoji ?? ''}</span>
 </div>
