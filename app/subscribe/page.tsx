...
>
 ...
 { label: 'Charity Contribution', pct: 10, color: 'var(--clr-success)', icon: '' },
 { label: 'Platform & Operations', pct: 40, color: 'var(--clr-primary)', icon: '' },
 ].map((item) => (
 <div key={item.label}>
 ...
 * You can voluntarily increase your charity % in your dashboard.
 ...
 {['� Secure payments via Stripe', '� Cancel anytime', ' Charity-first ethos', '�� UK-based platform'].map((b) => (
