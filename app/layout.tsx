...
export const metadata: Metadata = {
 ...
 description: 'A subscription golf platform combining performance tracking, monthly prize draws, and charitable giving. Play your best game and make a difference.',
