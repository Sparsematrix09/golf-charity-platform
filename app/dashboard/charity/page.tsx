          ...
          {selectedCharity && (
            <div className="card card-gold">
              ...
              <div style={{ display: 'flex', gap: 12, alignItems: 'center', marginBottom: 12 }}>
                <span style={{ fontSize: '2rem' }} aria-hidden="true">{selectedCharity.emoji ?? '❤️'}</span>
                <div>
          ...
          <div className="card">
            ...
            <form onSubmit={handleDonate} style={{ display: 'flex', gap: 12, flexWrap: 'wrap' }}>
              ...
              <div style={{ paddingTop: 22 }}>
                ...
                >
                  {donating ? <><span className="spinner" /> Processing...</> : 'Donate ❤️'}
                </button>
              </div>
            </form>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 8, maxHeight: 520, overflowY: 'auto' }}>
            {charities.length === 0 ? (
              ...
              charities.map((c) => (
                ...
                >
                  <span style={{ fontSize: '1.8rem', flexShrink: 0 }} aria-hidden="true">{c.emoji ?? '❤️'}</span>
